...
def load_HOLCVO(path):
    high = pd.read_csv(path+"//high.csv",index_col=[0])
    open = pd.read_csv(path+"//open.csv",index_col=[0])
    low = pd.read_csv(path+"//low.csv",index_col=[0])
    close = pd.read_csv(path+"//close.csv",index_col=[0])
    vol = pd.read_csv(path+"//vol.csv",index_col=[0])
    oi = pd.read_csv(path+"//oi.csv",index_col=[0])
