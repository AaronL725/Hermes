...
def EWM(X:np.array,alpha:float)->float:
    ...
    Returns:
        np.float: The exponentially weighted moving average of the input array X. If an element is non-positive or if it does not exist in X, it will be replaced with NaN.
...
@njit
def MAX(X:np.array, Y:np.array) -> np.array:
    """
    Calculate the element-wise maximum between two arrays X and Y.

    This function takes two numpy arrays X and Y as input and returns a new array
    where each element is the maximum of the corresponding elements in X and Y.
    ...
    Returns:
        np.array: A new array where each element is the maximum of the elements at
                   the corresponding positions in X and Y.

    Examples:
        >>> MAX(np.array([1, 2, 3]), np.array([4, 2, -1]))
        array([4, 2, 3])

        >>> MAX(np.array([0, 0, 0]), np.array([-1, 2, 3]))
        array([0, 2, 3])
    """
    return np.maximum(X, Y)

@njit
def MIN(X:np.array,Y:np.array)->np.array:
    """
    Calculate the element-wise minimum between two arrays X and Y.

    This function takes two numpy arrays X and Y as input and returns a new array
    where each element is the minimum of the corresponding elements in X and Y.
    ...
    Returns:
        np.array: A new array where each element is the minimum of the elements at
                   the corresponding positions in X and Y.

    Examples:
        >>> MIN(np.array([1, 2, 3]), np.array([4, 2, -1]))
        array([1, 2, -1])

        >>> MIN(np.array([0, 0, 0]), np.array([-1, 2, 3]))
        array([-1, 0, 0])
    """
